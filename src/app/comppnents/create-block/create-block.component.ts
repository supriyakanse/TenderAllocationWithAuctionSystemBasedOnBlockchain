...
export class CreateBlockComponent implements OnInit {
  ...
  constructor(public firebaseCongifService: FirebaseConfigService,private schedulerService: SchedulerService, private afStorage: AngularFireStorage,private router:Router) { }
